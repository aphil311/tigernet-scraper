...
1. Any time you write new code you must run `uv run tigernet-scraper --test McKinsey` to observe if there are obvious errors in the program. If there are, you must fix them.